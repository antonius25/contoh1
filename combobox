        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="kegiatan_setelah_lulus" name="kegiatan_setelah_lulus" onchange="pilih(this)" required>
            ...
            <div class="form-group">
              ...
              <input type="text" name="jurusan_universitas" id="jurusan_universitas" class="form-control">
            </div>
            <div class="form-group">
              <label>Alamat Universitas</label>
              <textarea  name="alamat_universitas"  class="form-control" id="alamat_universitas" rows="3"></textarea>
            </div>
            <div class="form-group">
              <label>No Tlp Univeristas</label>
              <input type="text" name="no_tlp_universitas" class="form-control" id="no_tlp_universitas">
            </div>
          </div>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <textarea name="alamat_wirausaha" class="form-control" rows="3" id="alamat_wirausaha"></textarea>
            </div>
            <div class="form-group">
              <label>No Hp Wirausaha</label>
              <input type="number" name="no_hp_wirausaha" class="form-control" id="no_hp_wirausaha">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control datepicker" name="tgl_mulai_kerja" id="tgl_mulai_kerja" autocomplete="off" />
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control datepicker" name="tgl_selesai_kerja" id="tgl_selesai_kerja" autocomplete="off" />
                <span class="input-group-addon">
                  <span class="glyphicon glyphicon-calendar"></span>
                </span>
              </div>
            ...
            <div class="form-group">
              ...
              <textarea name="alamat_instansi" class="form-control" id="alamat_instansi" rows="3"></textarea>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  {
    var cek = $('#kegiatan_setelah_lulus').val();
    if(cek=="Kuliah")
    {
      $("#nama_wirausaha").attr('disabled', true);
      $("#alamat_wirausaha").attr('disabled', true);
      $("#no_hp_wirausaha").attr('disabled', true);
      $("#nama_instansi").attr('disabled', true);
      $("#tgl_mulai_kerja").attr('disabled', true);
      $("#tgl_selesai_kerja").attr('disabled', true);
      $("#alamat_instansi").attr('disabled', true);
      $("#nama_universitas").attr('disabled', false);
      $("#no_tlp_universitas").attr('disabled', false);
      $("#fakultas_universitas").attr('disabled', false);
      $("#alamat_universitas").attr('disabled', false);
      $("#jurusan_universitas").attr('disabled', false);
    }

    else if(cek=="Wirausaha")
    {
      $("#nama_instansi").attr('disabled', true);
      $("#tgl_mulai_kerja").attr('disabled', true);
      $("#tgl_selesai_kerja").attr('disabled', true);
      $("#alamat_instansi").attr('disabled', true);
      $("#nama_universitas").attr('disabled', true);
      $("#no_tlp_universitas").attr('disabled', true);
      $("#fakultas_universitas").attr('disabled', true);
      $("#alamat_universitas").attr('disabled', true);
      $("#jurusan_universitas").attr('disabled', true);
      $("#nama_wirausaha").attr('disabled', false);
      $("#alamat_wirausaha").attr('disabled', false);
      $("#no_hp_wirausaha").attr('disabled', false);
    }
    ...
    else if(cek=='Bekerja')
    {
      ...
      $("#alamat_universitas").attr('disabled', true);
      $("#jurusan_universitas").attr('disabled', true);
      $("#nama_instansi").attr('disabled', false);
      $("#tgl_mulai_kerja").attr('disabled', false);
      $("#tgl_selesai_kerja").attr('disabled', false);
      $("#alamat_instansi").attr('disabled', false);
    }

    else if(cek=="Tidak bekerja/kuliah/wirausaha")
    {
      $("#nama_wirausaha").attr('disabled', true);
      $("#alamat_wirausaha").attr('disabled', true);
      $("#no_hp_wirausaha").attr('disabled', true);
